...
AutoCorres~\cite{greenaway2014don} translates C programs into abstract monadic models for Isabelle/HOL proofs.
...
\texttt{Rust2Isabelle} fills this missing connection by extending the Aeneas toolchain with an Isabelle/HOL backend and the dependency support required by the generated theories.