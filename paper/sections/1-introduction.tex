...
\autoref{sec:evaluation} combines construct-level coverage with an SBPF (Solana eBPF) virtual machine case study, Isabelle acceptance, and selected semantic properties.
