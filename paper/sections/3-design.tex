...
The backend uses this context to translate each output module into an Isabelle theory.
...
Pure constructs with direct Isabelle counterparts are translated into the corresponding types, terms, and declarations.
